  ...
  const BuyPMT = () => {
    ...
    return (
      ...
      <div className={styles.container}>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <h3 className={styles.title1}>Pre-Sale Phase 10 ends soon! </h3>
            <p className={styles.explain}>
              Pre-sale Phase 10 of 10  {" "}
            ...
            <Line  percent={72} strokeWidth={1} strokeColor="green" className={styles.blink_me}  trailColor="grey" trailWidth={1} />
      ...
      If you are one of the first 1000 pre-sale buyers with at least 10,000 $PMT, you will be among the first lucky ones to be rewarded with exclusive LOYALTY NFTs for FREE. Get ready for a truly remarkable statement of ours Appreciation captured!  {" "}
            ...
            <h1 style={{ color:"#fbbe7c"  }}>PHASE 10 ENDS IN</h1>
           <Countdown date={`${year}-01-17T13:00:00`} />
