...
const PrivacyModal = (props) => {
    ...
    const policyText = (
        ...
        Public Meme Token Privacy Policy.
Last updated: [[Date]]

This Privacy Policy describes how Public Meme Token (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from https://Publicmemetoken.com/ (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
...
Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call [[TOLL FREE TELEPHONE NUMBER IF YOU HAVE A PHYSICAL RETAIL LOCATION]] or email us at Publicmemetoken@gmail.com or contact us at BNB-Chain, Blockchain, AL, BEP20, United States.       
        </p>
        </div>
    );
    const Imprint = (
